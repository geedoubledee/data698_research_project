...
We tokenize the refined text into unigrams, bigrams, and trigrams.
...
```{r nb2, warning = FALSE, message = FALSE}
fol <- c("models2/")
dat <- c("uni_", "bi_", "tri_", "all_")
fns <- c("nb1.rds", "nb2.rds", "nb3.rds", "nb4.rds", "nb5.rds", "nb6.rds",
         "nb7.rds")
...
```{r xgb2, warning = FALSE, message = FALSE}
fns <- c("xgb1.rds", "xgb2.rds", "xgb3.rds", "xgb4.rds", "xgb5.rds", "xgb6.rds",
         "xgb7.rds")
xgbs <- list()
count = 0
